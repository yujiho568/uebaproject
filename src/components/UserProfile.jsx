    ...
    <div className="user-profile">
      ...
      >
        <div className="user-profile__avatar">
          <span className="user-profile__initials">U</span>
        </div>
        <span className="user-profile__name">User</span>
        ...
        <div className="user-profile__dropdown">
          <div className="user-profile__header">
            ...
            <div className="user-profile__info">
              <div className="user-profile__fullname">User Name</div>
              <div className="user-profile__email">user@example.com</div>
            </div>
          </div>
          <div className="user-profile__menu">
            ...
            <button className="user-profile__menu-item user-profile__menu-item--logout">Sign Out</button>
          </div>
        </div>
      )}
    </div>
